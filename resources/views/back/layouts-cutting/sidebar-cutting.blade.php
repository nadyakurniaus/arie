        ...
        <div>
            <div>
                <ul class="site-menu" data-plugin="menu">
                    ...
                    <li class="site-menu-item">
                        <a href="{{ route('proses.cutting') }}">
                            <i class="site-menu-icon wb-scissor" aria-hidden="true"></i>
                            <span class="site-menu-title">Tambah Cutting</span>
                        </a>
                    </li>
                </ul>
            </div>
