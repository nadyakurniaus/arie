        ...
        var dt = $('.table-user').DataTable({
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        ...
                        .prepend(
                            ...
                            '<h4 align="center">Laporan Daftar Permintaan Pembelian Bahan Baku - {!!\Carbon\Carbon::now()->format('d/m/Y')!!} </h4>'+
                            '</div>'+
                            '</div>'+
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        if (data == 'on process'){
                            return '<button type="button" class="btn btn-success btn-approve btn-sm"><span class="icon wb-check-mini"></span>Approve</button>' +
                            '<button type="button" class="btn btn-danger btn-reject btn-sm"><span class="icon wb-close-mini"></span>Reject</button>';

                        }else{

                        }
                        return '<button type="button" class="btn btn-success btn-approve btn-sm" disabled><span class="icon wb-check-mini"></span>Approve</button>' +
                            '<button type="button" class="btn btn-danger btn-reject btn-sm" disabled><span class="icon wb-close-mini"></span>Reject</button>';
                    }
                }
            ],
        })
