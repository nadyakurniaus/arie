...
<div class="page">
    <div class="page-header">
      <h1 class="page-title">Monitoring Bahna Baku</h1>
      <ol class="breadcrumb">
      ...
      <div class="page-header-actions">
            <form action="{{ route('monitoring.update', $bahan->id) }}" method="POST" autocomplete="off">
        ...
        <div class="col-lg-7  col-xs-12">
          ...
          <div class="panel">
            <div class="panel-heading">
              <h3 class="panel-title">Ubah Stok Minimum Bahan Baku</h3>
            </div>
