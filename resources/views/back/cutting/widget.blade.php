@extends('back.layouts-cutting.base')
...
<div class="page">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Bagian Cutting</a></li>
            <li class="breadcrumb-item active">Tambah Cutting</li>
        </ol>
    ...
    <div class="modal-dialog modal-simple">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Proses Cutting</h4>
                <br>
                <div class="form-group">
                    <label for="tanggal_order" class="col-sm-4 control-label">Tanggal Masuk Cutting</label>
                    <div class="col-sm-6">
...
<script>
    $(function() {
        $("#qty_printing").keyup(function(){
            if ($('#qty_printing').val() > $('#targetP').val())
            {
            alert('Qty melebihi target');
        ...
        setTimeout(() => {
            ...
            $('#labelTanggal').html('Daftar Menunggu Proses Cutting ' );
            showTable();
        ...
        $('#simpanCuting').click(() => {
            $.ajax({
                url: '{{ route("cutting.simpanDetail") }}',
                type: "POST",
                data: {
                    'id': $('#id_produksiC').val(),
                    'qty': $('#qty_cuting').val(),
    ...
    function showTable() {
        ...
        dtTable = $(".table-user").DataTable({
            ...
            ajax: ({
                url: '{{ route("cutting.dtProduksiCTG2") }}',
                type: "POST",
                data: data,
                dataType: "JSON",
                headers: {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if (data != '3') {
                            return '<button type="button" class="btn btn-icon btn-warning btn-cuting" data-target="#modalCuting" data-toggle="modal" disabled><i class="icon wb-scissor" aria-hidden="true"></i></button>'+
                            ...
                            return '<button type="button" class="btn btn-icon btn-warning btn-cuting" data-target="#modalCuting" data-toggle="modal"><i class="icon wb-scissor" aria-hidden="true"></i></button>'+
                            '<button type="button" class="btn btn-icon btn-info" data-target="#modalDetail" data-toggle="modal"><i class="icon wb-info" aria-hidden="true"></i></button>'
                        }
                    }
                }
