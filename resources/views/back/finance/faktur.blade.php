...
<div class="page">
    <div class="page-header">
        <h1 class="page-title">Faktur Pelunasan Pembayaran</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/finance">Bagian Finance</a></li>
            <li class="breadcrumb-item"><a href="javascript:void(0)">Kelola Pembayaran</a></li>
            <li class="breadcrumb-item active">Faktur Pelunasan Pembayaran</li>
        </ol>
        <div class="page-header-actions">
            <a href="{{ route('finance') }}" class="btn btn-md btn-icon btn-outline btn-warning btn-round" data-toggle="tooltip" data-original-title="Kembali ke Order">
              ...
              <div class="panel-body container-fluid">
                <div class="row">
                  ...
                  <div class="col-xs-12 col-lg-3 offset-lg-6 text-xs-right">
                    <h4>Faktur Info</h4>
                    <p>
                    <a class="font-size-20" href="javascript:void(0)">{{ $item->no_faktur }}</a>
                      <br>
                        <span>Karawang, {{$item->tanggal_order}}</span>
                      <br> Yth :
                      <span class="font-size-16">{{ $item->name}}</span>
                      <br> No. Telepon : {{ $item->no_telfon}}
                    </p>
                    <br>
                    <br>
                  </div>
                ...
                <div class="text-xs-right clearfix">
                  <div class="pull-xs-right">
                    ...
                    <span>Rp.{{ $value->total_pembayaran }},-</span>
                    </p>
                    <p class="page-invoice-amount">Sisa Pembayaran saat ini:
                    <span>Rp.{{ $value->sisa_pembayaran }},-</span>
                    </p>
                    <p>Pembayaran Masuk:
                    <span>Rp. {{ $value->uang_masuk }},-</span>
                    </p>
                    <p class="page-invoice-amount">Sisa Pembayaran:
                    <span>Rp. 0,- / {{ $value->tipe_pembayaran }}</span>
                    </p>
                  </div>
                </div>
                @endforeach
