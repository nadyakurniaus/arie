...
<div class="page">
    <div class="page-header" id="headerFaktur">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/admin">Supervisor Produksi</a></li>
              ...
              <div class="panel-body container-fluid">
                <div class="row">
                  ...
                  <div class="col-xs-12 col-lg-3 offset-lg-6 text-xs-right">
                    ...
                    <a class="font-size-20" href="javascript:void(0)">{{ $penjualan->no_faktur }}</a>
                      <br>
                      <div class="row"> Karawang,
                            <span class="date">{{$penjualan->tanggal_order}}</span>
                        </div>
                      Yth :
                  ...
                  <table class="table table-hover text-xs-right">
                    ...
                    @foreach ($item as $value)
                      <tr>
                        ...
                        <td class="text-xs-center">
                            {{ $value->produk->bahan->nama}}
                        </td>
                        <td class="text-xs-center">
                            {{ $value->produk->ukuran->nama}}
                        </td>
                        <td class="text-xs-center">
                            {{ $value->jumlah}}
                        </td>
                ...
                <div class="text-xs-right clearfix">
                  <div class="pull-xs-right">
                    ...
                    <span>Rp.{{ $pembayaran[0]->total_pembayaran }},-</span>
                    </p>
                    <p>Pembayaran Masuk:
                    <span>Rp. {{ $pembayaran[0]->uang_masuk }},-</span>
                    </p>
                    <p class="page-invoice-amount">Sisa Pembayaran:
                    <span>Rp. {{ $pembayaran[0]->sisa_pembayaran }},- / {{ $pembayaran[0]->tipe_pembayaran }}</span>
                    </p>
                  </div>
                </div>
...
$(function () {
  $('.date').each(function (index, dateElem) {
    ...
    var formatted = moment($dateElem.text(), 'YYYY-DD-MM').format('DD MMMM, YYYY');
